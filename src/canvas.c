 ...
 */
t_canvas *
canvas_create (int width, int height, const char *title)
{
    t_canvas *canvas;
    int y;
 ...
 */
void
canvas_destroy (t_canvas *canvas)
{
    int y;
 ...
 */
void
canvas_write_pixel (t_canvas *canvas, int x, int y, t_color color)
{
    uint32_t rgba;
 ...
 */
t_color
canvas_pixel_at (t_canvas *canvas, int x, int y)
{
    if (!canvas || x < 0 || x >= canvas->width || y < 0 || y >= canvas->height)
        return (color (0, 0, 0));
 ...
 */
void
canvas_clear (t_canvas *canvas, t_color clear_color)
{
    int x, y;
